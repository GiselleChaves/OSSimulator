    ...
    public Program[] progs = {
            ...
            new Program("soma",
                    new Word[]{
                            ...
                            new Word(Opcode.LDI, 1, -1, 20), // r1 = 20  
                            new Word(Opcode.ADD, 0, 1, -1),  // r0 = r0 + r1
                            new Word(Opcode.STD, 0, -1, 10), // [10] = r0
                            new Word(Opcode.STOP, -1, -1, -1), // finaliza
                            new Word(Opcode.DATA, -1, -1, -1),
                            new Word(Opcode.DATA, -1, -1, -1),
                            new Word(Opcode.DATA, -1, -1, -1),
                            new Word(Opcode.DATA, -1, -1, -1),
                            new Word(Opcode.DATA, -1, -1, -1),
                            new Word(Opcode.DATA, -1, -1, -1) // resultado aqui
                    }),
                    
            new Program("loop",
                    new Word[]{
                            new Word(Opcode.LDI, 0, -1, 5),   // contador = 5
                            new Word(Opcode.LDI, 1, -1, 1),   // decremento = 1
                            new Word(Opcode.SUB, 0, 1, -1),   // contador--
                            new Word(Opcode.JMPIG, 2, 0, -1), // se contador > 0, volta para SUB
                            new Word(Opcode.STOP, -1, -1, -1) // senão, para
                    })
    };
} 